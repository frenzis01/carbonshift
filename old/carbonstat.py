...
def export_assignment(assignment,data,output_assignment):
    ...
    output_csv.write("requests,time_slot,strategy,carbon_actual,carbon_forecast\n")
...
parser.add_argument('input_time_slots', type=str, help='File with time slot data')              # input_requests_STAT.csv
parser.add_argument('input_strategies', type=str, help='File with statistics on strategies')    # input_strategies_STAT.csv
